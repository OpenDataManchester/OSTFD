...
|completePackagingConstituentsIdentifier|`mandatory`|List|The information regarding the consituents that are combined to create this garment. The entries should be from the [Garment Constituents Relationship List](../6_Relationship_Lists/6_003_Complete_Packaging_Constituents.md) identifier.|
...
|productType|`optional`|String|Information about the product contained in the garment. The entry here should be drawn from the [product type controlled list](../5_Controlled_Lists/5_012_Product_Type.md).|
...
|depositReturnSchemes|`mandatory`|List|Which countries support a deposit return scheme for this particular garment? The entries here should be drawn from the [deposit return scheme controlled list](../5_Controlled_Lists/5_013_Deposit_Return_Scheme.md).|
|completePackagingEndOfLifeRoutes|`optional`|List|The information regarding this garment's proposed end of life routes. The entries should be the [garment end of life routes](../6_Relationship_Lists/6_008_Complete_Packaging_End_of_Life_Routes.md) identifiers.|
...
measurements :fontawesome-solid-square-plus:{ title="Added to this version" .addition }|`mandatory`|List|The information regarding the measurements of the garment. The entries should be from the [Measurements Relationship List](../6_Relationship_Lists/6_012_Measurements.md).|
